...
const authActions = {
    postUser: (newUser)=>{
        return async(dispatch, getState)=>{
            try{
                const user = await axios.post("https://my-tinerary-takaes.herokuapp.com/api/auth/signUp",{...newUser})
    ...
    signIn: (email,password,google)=>{
        return async(dispatch, getState)=>{
            try{
                const user = await axios.post("https://my-tinerary-takaes.herokuapp.com/api/auth/signIn",{email,password,google})
    ...
    signToken: ()=>{
        return async (dispatch, getState) => {
            ...
            const response = await axios.get("https://my-tinerary-takaes.herokuapp.com/api/auth",{
                headers: {
